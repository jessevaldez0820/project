...
namespace Group25_Final_Project.Controllers
{
    ...
    //Only admin has control of this control and its methods
    ...
    public class RoleAdminController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            foreach (IdentityRole role in _roleManager.Roles)
            {
                ...
                RoleEditModel rem = new RoleEditModel
                {
                    ...
                    Members = members, //list of users in this role
                    NonMembers = nonMembers //list of users NOT in this role
                };
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            RoleEditModel rem = new RoleEditModel
            {
                ...
                //populate the properties of the role edit model
                Role = role, //role looked up from database
                Members = members, //list of users in the role
                NonMembers = nonMembers //list of users NOT in the role
            };
