        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopcornPoints = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Matinee = table.Column<decimal>(nullable: false),
                    WeekdayAfternoon = table.Column<decimal>(nullable: false),
                    TuesdayAfternoon = table.Column<decimal>(nullable: false),
                    Weekend = table.Column<decimal>(nullable: false),
                    SpecialEvent = table.Column<decimal>(nullable: false),
                    SeniorCitizen = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiftRecId = table.Column<string>(nullable: true),
                    GiftAttribute = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MPAARating = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewString = table.Column<string>(maxLength: 280, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TheaterNo = table.Column<string>(nullable: true),
                    SeatCount = table.Column<int>(nullable: false),
                    ShowingStatus = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SelectedSeat = table.Column<string>(nullable: true),
                    ...
                    TotalTicketFee = table.Column<decimal>(nullable: false),
